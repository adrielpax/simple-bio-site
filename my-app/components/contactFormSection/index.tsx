...
export default function ContactFormSection() {
  ...
  return (
    <section
      id="contact-section"
      className="w-full py-12 md:py-16 px-4 -mt-32 md:-mt-24 relative z-10"
    >
      <div className="max-w-5xl mx-auto">
        {/* Card destacado com gradiente */}
        <div
          className="rounded-3xl p-6 md:p-12 border border-white/20
          ...
          <div className="relative z-10">
            <div className="text-center mb-8 md:mb-12">
              <div className="inline-flex items-center gap-2 mb-4 px-4 py-2 rounded-full 
                ...
                <span className="text-cyan-400 text-xs font-bold uppercase">Oportunidade Limitada</span>
              </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 md:gap-12">
              ...
              <div className="lg:col-span-2">
                <form onSubmit={handleSubmit} className="flex flex-col gap-4 md:gap-5">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="flex flex-col gap-2">
                      ...
                      <input
                        ...
                        className="shadow-sm px-4 py-3 rounded-lg
                  ...
                  <button
                    type="submit"
                    className="uppercase text-shadow-lg/20 rounded-lg px-8 py-4 border border-white/30 
              ...
              <div className="lg:col-span-1 flex flex-col gap-4">
                <div className="p-6 rounded-2xl backdrop-blur border border-white/10
                  bg-gradient-to-br from-white/5 to-white/10">
                  <h3 className="uppercase text-shadow-lg font-bold text-lg mb-4 text-white">
                    O Que Você Recebe:
                  </h3>
                ...
                <div className="p-6 rounded-2xl backdrop-blur border border-cyan-500/20
                  bg-gradient-to-br from-cyan-500/10 to-green-500/10">
                  <div className="flex items-center gap-3 mb-3">
                    <Mail className="w-5 h-5 text-cyan-400" />
                    <span className="text-white font-bold text-sm">Email Rápido</span>
                  </div>
                  <a
                    href="mailto:contato@elevardigital.com"
                    className="text-cyan-400 hover:text-cyan-300 text-sm transition-colors break-all"
                  >
