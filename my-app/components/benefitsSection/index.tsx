...
export default function BenefitsSection() {
  return (
    <section
      id="benefits-section"
      className="w-full py-20 md:py-32 px-4 bg-[#f5f5f5] relative overflow-hidden"
    >
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-16 md:mb-20">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full 
            bg-gradient-to-r from-cyan-100 to-green-100 mb-6">
            <Sparkles className="w-4 h-4 text-cyan-600" />
            <span className="text-cyan-700 text-xs font-bold uppercase">Vantagens Exclusivas</span>
          </div>
          <h2 className="font-bold text-4xl md:text-5xl lg:text-6xl mb-6 text-gray-900 leading-tight">
            Por Que Escolher a{" "}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-10">
          {benefits.map((benefit, index) => (
            ...
            >
              <div
                className={`flex flex-col rounded-3xl p-8 border-2 
        ...
        <div className="text-center mt-16 md:mt-20">
          <div className="inline-flex items-center gap-3 px-8 py-4 rounded-full
            ...
            <Target className="w-6 h-6 text-white group-hover:rotate-12 transition-transform" />
            <span className="text-white font-bold text-lg">Veja Todos os Benefícios</span>
