...
export default function BenefitsSection() {
  return (
    <section
      id="benefits-section"
      className="w-full py-12 sm:py-16 md:py-20 lg:py-32 px-4 sm:px-6 bg-[#f5f5f5] relative overflow-hidden"
    >
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-8 sm:mb-12 md:mb-16 lg:mb-20">
          <div className="inline-flex items-center gap-2 px-3 sm:px-4 py-1.5 sm:py-2 rounded-full 
            bg-gradient-to-r from-cyan-100 to-green-100 mb-4 sm:mb-6">
            <Sparkles className="w-3 h-3 sm:w-4 sm:h-4 text-cyan-600" />
            <span className="text-cyan-700 text-[10px] sm:text-xs font-bold uppercase">Vantagens Exclusivas</span>
          </div>
          <h2 className="font-bold text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl mb-4 sm:mb-6 text-gray-900 leading-tight px-2">
            Por Que Escolher a{" "}
          ...
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-gray-600 max-w-3xl mx-auto leading-relaxed px-2">
            ...
            <span className="font-bold text-gray-900">parceiros estratégicos</span> na jornada de
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8 lg:gap-10">
          {benefits.map((benefit, index) => (
            ...
            >
                <div
                  className={`flex flex-col rounded-2xl sm:rounded-3xl p-4 sm:p-6 md:p-8 border-2 
                ...
                <div className="relative z-10">
                  ...
                  <div className={`mb-4 sm:mb-6 p-3 sm:p-4 rounded-xl sm:rounded-2xl w-fit
                    ${
                      benefit.color === "cyan"
                        ? "bg-gradient-to-br from-cyan-100 to-cyan-50 text-cyan-600"
                  ...
                  {/* Título */}
                  <h3 className="font-bold text-lg sm:text-xl md:text-2xl lg:text-3xl mb-3 sm:mb-4 text-gray-900">
                    {benefit.title}
                  </h3>
